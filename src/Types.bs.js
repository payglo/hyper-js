...
function emptyPaygloInstance_elements(_ev) {
  return emptyElement;
}

function emptyPaygloInstance_widgets(_ev) {
  return emptyElement;
}

function emptyPaygloInstance_paymentRequest(_ev) {
  return null;
}

var emptyPaygloInstance = {
  confirmPayment: confirmPaymentFn,
  elements: emptyPaygloInstance_elements,
  confirmCardPayment: confirmCardPaymentFn,
  retrievePaymentIntent: retrievePaymentIntentFn,
  widgets: emptyPaygloInstance_widgets,
  paymentRequest: emptyPaygloInstance_paymentRequest
};
